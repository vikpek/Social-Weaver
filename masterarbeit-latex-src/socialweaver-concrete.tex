...
%%% TODO not verbatim but listing bla
\begin{verbatim}
{
    rules:
    [
...
In the abstract section we defined a couple of abstract requirements that we need to specify for a proper implementation. Those requirements were:
